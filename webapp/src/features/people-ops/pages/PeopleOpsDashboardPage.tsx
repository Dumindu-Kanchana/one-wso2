...
// The People Ops overview dashboard — a Novera insight, quick actions, a
// KPI strip and the Hiring / Candidates / Performance / People / Ops
// sections. Reachable from the "Dashboard" rail item. Sample data.
